...
function sortByValues(dictionary) {
  ...
  let sortedDictionary = new Map(entries);
...
function convertDictionaryToSet(dictionary) {
  // Створюємо порожню множину для зберігання ключів
...
function convertSetToDictionary(set) {
  // Створюємо порожній словник для зберігання результатів
